...
public class InterfazInicio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblBarraBanner.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/BarraInicio.png"))); // NOI18N
        ...
        cbRol.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Usuario" }));
    ...
    private void jblLoginMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jblLoginMouseClicked
        tbpVentanas.setSelectedIndex(1);
        txtsPorDefecto();
        ...
        try {
            ...
            if(nombre.trim().equals("") || apellido.trim().equals("") || telefono.trim().equals("") || cedula.trim().equals("") || password.trim().equals("")){
                ...
                if(nombre.equals("Ingrese su usuario") || apellido.equals("Ingrese sus apellidos") || telefono.equals("Ingrese su telefono")
                    ...
                    Personas p = new Personas(nombre, apellido, password, cedula, telefono, 0, 0, 0);
